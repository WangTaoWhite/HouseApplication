...
public class ColorTextView extends View {
    private static final int DEFAULT_SIZE_SP = 15;
    ...
    public ColorTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mTextSize = DimensionUtil.sp2px(context, DEFAULT_SIZE_SP);
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);

        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.ColorTextView);
        mText = ta.getString(R.styleable.ColorTextView_text);
        mTextSize = ta.getDimensionPixelSize(R.styleable.ColorTextView_text_size, mTextSize);
        mTextOriginColor = ta.getColor(R.styleable.ColorTextView_text_origin_color, mTextOriginColor);
        mTextChangeColor = ta.getColor(R.styleable.ColorTextView_text_change_color, mTextChangeColor);
        mProgress = ta.getFloat(R.styleable.ColorTextView_progress, 0);
        mDirection = ta.getInt(R.styleable.ColorTextView_direction, mDirection);
        ta.recycle();
